...
## 斯坦福最火CS课
《现代软件开发者》（CS146S: The Modern Software Developer），禁止手写一行代码，全靠 AI 生成
手写代码的时代正在倒计时。
>未来的竞争，不是谁的代码写得更漂亮，而是谁能驾驭 AI 更快地解决问题。如果你还坚持“纯手工打造”，就像在工业革命时期坚持手工纺纱一样，注定会被淘汰。
如果今天你不敢把代码权交给 AI，明天 AI 就会把你的工位交给别人。
>
- 知乎-斯坦福 CS146S 震撼开课：禁止手写一行代码，全靠 AI 生成！ https://zhuanlan.zhihu.com/p/1981311901574140527
- 斯坦福课程链接 https://bulletin.stanford.edu/courses/2274401
- CS146S中文版 https://github.com/ShouZhengAI/CS146S_CN

## cursor使用说明

- 2025-06-用Cursor开启JAVA+AI生涯 https://mp.weixin.qq.com/s/IjtFS7BtAmsgrGdeD-JXKg
- 2025-06-深入解析｜Cursor编程实践经验分享 https://mp.weixin.qq.com/s/UQPcxiV4UsTxpPYRjaNZIA
- 2026-01-AI Coding 长文分享：如何真正把工具用起来，从原理到实践 https://mp.weixin.qq.com/s/MjBVTfo6Kp2RDG6v46_BPA

### CLI 安装（Windows / WSL）

Windows 原生暂不支持 Cursor CLI，需先进入 **WSL** 终端，再执行安装（[官方文档](https://docs.cursor.com/cli)）：

```sh
curl https://cursor.com/install -fsS | bash
```

安装完成后将 `~/.local/bin` 加入 PATH 并生效：
...
在 WSL 终端执行 `agent` 即可启动 Cursor Agent。

...
从 [Releases](https://github.com/wkentaro/labelme/releases) 下载对应系统的安装包或压缩包（例如 [v5.5.0](https://github.com/wkentaro/labelme/releases/tag/v5.5.0)），解压后运行 `Labelme` 或 `labelme.exe`。
